// Game Server Configuration - EXAMPLE FILE
// ================================
// 
// COPY THIS FILE TO config.js AND UPDATE THE RAILWAY URL
// 
// cp config.example.js config.js
// 
// Then edit config.js and change the Railway URL
...
const SERVER_CONFIG = {
  ...
  railway: {
    url: 'https://your-railway-app-name.railway.app', // ← CHANGE THIS TO YOUR RAILWAY URL
    name: 'Railway Production'
  },
  
  // itch.io deployment
  itch: {
    url: 'https://your-railway-app-name.railway.app', // ← SAME AS RAILWAY
...
console.log('  • Example Railway URL: https://wargame-server.railway.app');
